...
func OwnerID(id int) predicate.Car {
	return predicate.Car(func(s *sql.Selector) {
		s.Where(sql.EQ(s.C(OwnerColumn), id))
	})
}

// OwnerIDEQ applies the EQ predicate on the user_cars field.
func OwnerIDEQ(id int) predicate.Car {
	return predicate.Car(func(s *sql.Selector) {
		s.Where(sql.EQ(s.C(OwnerColumn), id))
	})
}

// OwnerIDNEQ applies the NEQ predicate on the user_cars field.
func OwnerIDNEQ(id int) predicate.Car {
	return predicate.Car(func(s *sql.Selector) {
		s.Where(sql.NEQ(s.C(OwnerColumn), id))
	})
}

// OwnerIDIn applies the In predicate on the user_cars field.
func OwnerIDIn(ids ...int) predicate.Car {
	return predicate.Car(func(s *sql.Selector) {
		// if not arguments were provided, append the FALSE constants,
		// since we can't apply "IN ()". This will make this predicate falsy.
		if len(ids) == 0 {
...
// OwnerIDNotIn applies the NotIn predicate on the user_cars field.
func OwnerIDNotIn(ids ...int) predicate.Car {
	return predicate.Car(func(s *sql.Selector) {
		// if not arguments were provided, append the FALSE constants,
		// since we can't apply "IN ()". This will make this predicate falsy.
		if len(ids) == 0 {
...
// OwnerIDGT applies the GT predicate on the user_cars field.
func OwnerIDGT(id int) predicate.Car {
	return predicate.Car(func(s *sql.Selector) {
		s.Where(sql.GT(s.C(OwnerColumn), id))
	})
}

// OwnerIDGTE applies the GTE predicate on the user_cars field.
func OwnerIDGTE(id int) predicate.Car {
	return predicate.Car(func(s *sql.Selector) {
		s.Where(sql.GTE(s.C(OwnerColumn), id))
	})
}

// OwnerIDLT applies the LT predicate on the user_cars field.
func OwnerIDLT(id int) predicate.Car {
	return predicate.Car(func(s *sql.Selector) {
		s.Where(sql.LT(s.C(OwnerColumn), id))
	})
}

// OwnerIDLTE applies the LTE predicate on the user_cars field.
func OwnerIDLTE(id int) predicate.Car {
	return predicate.Car(func(s *sql.Selector) {
