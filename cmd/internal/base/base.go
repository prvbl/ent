...
func InitCmd() *cobra.Command {
	var target, tmplPath, prefix string
	cmd := &cobra.Command{
		...
		Run: func(cmd *cobra.Command, names []string) {
			...
			if err := initEnv(target, prefix, names, tmpl); err != nil {
...
func initEnv(target string, prefix string, names []string, tmpl *template.Template) error {
