...
func SpouseID(id uint64) predicate.User {
	return predicate.User(func(s *sql.Selector) {
...
func SpouseIDEQ(id uint64) predicate.User {
	return predicate.User(func(s *sql.Selector) {
		s.Where(sql.EQ(s.C(SpouseColumn), id))
	})
}
...
func SpouseIDNEQ(id uint64) predicate.User {
	return predicate.User(func(s *sql.Selector) {
...
func SpouseIDIn(ids ...uint64) predicate.User {
	return predicate.User(func(s *sql.Selector) {
		// if not arguments were provided, append the FALSE constants,
		// since we can't apply "IN ()". This will make this predicate falsy.
		if len(ids) == 0 {
...
func SpouseIDNotIn(ids ...uint64) predicate.User {
	return predicate.User(func(s *sql.Selector) {
		// if not arguments were provided, append the FALSE constants,
		// since we can't apply "IN ()". This will make this predicate falsy.
		if len(ids) == 0 {
...
func SpouseIDGT(id uint64) predicate.User {
	return predicate.User(func(s *sql.Selector) {
...
func SpouseIDGTE(id uint64) predicate.User {
	return predicate.User(func(s *sql.Selector) {
...
func SpouseIDLT(id uint64) predicate.User {
	return predicate.User(func(s *sql.Selector) {
...
func SpouseIDLTE(id uint64) predicate.User {
	return predicate.User(func(s *sql.Selector) {
