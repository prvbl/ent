...
func (uc *UserCreate) SetOccupation(s string) *UserCreate {
	uc.mutation.SetOccupation(s)
	return uc
}

// SetNillableOccupation sets the "occupation" field if the given value is not nil.
func (uc *UserCreate) SetNillableOccupation(s *string) *UserCreate {
	if s != nil {
		uc.SetOccupation(*s)
	} else {
		uc.mutation.ClearOccupation()
	}
...
func (uc *UserCreate) defaults() {
	...
	if _, ok := uc.mutation.Occupation(); !ok {
		v := user.DefaultOccupation
		uc.mutation.SetOccupation(v)
	}
}
...
func (uc *UserCreate) createSpec() (*User, *sqlgraph.CreateSpec) {
	...
	if value, ok := uc.mutation.Name(); ok {
		...
		_node.Name = &value
	} else if uc.mutation.NameCleared() {
	...
	} else if uc.mutation.LastNameCleared() {
		_spec.SetField(user.FieldLastName, field.TypeString, nil)
	}
	...
	} else if uc.mutation.OccupationCleared() {
		_spec.SetField(user.FieldOccupation, field.TypeString, nil)
	}
