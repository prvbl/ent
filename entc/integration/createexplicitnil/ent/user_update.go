...
func (uu *UserUpdate) SetOccupation(s string) *UserUpdate {
	uu.mutation.SetOccupation(s)
	return uu
}

// SetNillableOccupation sets the "occupation" field if the given value is not nil.
func (uu *UserUpdate) SetNillableOccupation(s *string) *UserUpdate {
	if s != nil {
		uu.SetOccupation(*s)
	} else {
		uu.mutation.ClearOccupation()
	}
...
func (uu *UserUpdate) ClearOccupation() *UserUpdate {
	uu.mutation.ClearOccupation()
	return uu
}
...
func (uu *UserUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if value, ok := uu.mutation.Occupation(); ok {
		_spec.SetField(user.FieldOccupation, field.TypeString, value)
	}
	if uu.mutation.OccupationCleared() {
		_spec.ClearField(user.FieldOccupation, field.TypeString)
	}
...
// SetOccupation sets the "occupation" field.
func (uuo *UserUpdateOne) SetOccupation(s string) *UserUpdateOne {
	uuo.mutation.SetOccupation(s)
	return uuo
}

// SetNillableOccupation sets the "occupation" field if the given value is not nil.
func (uuo *UserUpdateOne) SetNillableOccupation(s *string) *UserUpdateOne {
	if s != nil {
		uuo.SetOccupation(*s)
	} else {
		uuo.mutation.ClearOccupation()
	}
...
// ClearOccupation clears the value of the "occupation" field.
func (uuo *UserUpdateOne) ClearOccupation() *UserUpdateOne {
	uuo.mutation.ClearOccupation()
	return uuo
}
...
func (uuo *UserUpdateOne) sqlSave(ctx context.Context) (_node *User, err error) {
	...
	if uuo.mutation.OccupationCleared() {
		_spec.ClearField(user.FieldOccupation, field.TypeString)
	}
