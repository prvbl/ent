...
func (m *UserMutation) SetOccupation(s string) {
	m.occupation = &s
}

// Occupation returns the value of the "occupation" field in the mutation.
func (m *UserMutation) Occupation() (r string, exists bool) {
	v := m.occupation
	if v == nil {
		return
	}
...
// If the User object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *UserMutation) OldOccupation(ctx context.Context) (v string, err error) {
	if !m.op.Is(OpUpdateOne) {
...
func (m *UserMutation) ClearOccupation() {
	m.occupation = nil
	m.clearedFields[user.FieldOccupation] = struct{}{}
}

// OccupationCleared returns if the "occupation" field was cleared in this mutation.
func (m *UserMutation) OccupationCleared() bool {
	_, ok := m.clearedFields[user.FieldOccupation]
	return ok
}
...
func (m *UserMutation) ResetOccupation() {
	m.occupation = nil
	delete(m.clearedFields, user.FieldOccupation)
}
...
func (m *UserMutation) ClearedFields() []string {
	...
	if m.FieldCleared(user.FieldOccupation) {
		fields = append(fields, user.FieldOccupation)
	}
	return fields
}
