...
func templateWhereTmpl() (*asset, error) {
	...
	info := bindataFileInfo{name: "template/where.tmpl", size: 5000, mode: os.FileMode(420), modTime: time.Unix(1, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
